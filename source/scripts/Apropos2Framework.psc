...
Function RegisterForEvents()
    ...
    RegisterForModEvent("HookStageEnd", "StageEnd")
...
Event AnimationEnd(int threadID, bool HasPlayer)
    ...
    SslThreadController thread = SexLab.GetController(threadID)
    If Config.DebugMessagesEnabled
        LogEventInfo("AnimationEnd", thread)
    EndIf
    Descriptions.ProcessAnimEndWT(thread, thread.Stage)
EndEvent
...
Event StageStart(int threadID, bool HasPlayer)
    ...
    Descriptions.ProcessStageStartWT(thread, thread.Stage)
EndEvent

Event StageEnd(int threadID, bool HasPlayer)
    If !CheckCanRun("StageEnd")
        Return
    EndIf
    ...
    ; EndIf
    If Config.DebugMessagesEnabled
        LogEventInfo("StageEnd", thread)
    EndIf

    ;Descriptions.DisplayStageEndMessage(thread, thread.Stage)
EndEvent
